...
const products = [
  ...
  { id: 11, name: 'Enrollables en screen', imagen_url: "https://res.cloudinary.com/dcx3jprqf/image/upload/v1748021817/productos/Enrollable.jpg", price: 120.00 },
];

export default function ProductSection() {
  // Ahora, los Hooks se llaman dentro del componente funcional
  ...
  return (
    <div className="relative">
      {/* Botón del carrito */}
      <div className="fixed right-6 z-40 position absolute bottom-168 right-65">
        <button
      ...
      {isCartOpen && (
        <div className="fixed top-20 right-6 w-80 bg-white p-6 rounded-xl shadow-2xl z-40">
          ...
          <button
            onClick={() => setCart([])}
            className="mt-4 mx-10 w-45 bg-[#E5BC57] text-black flex items-center py-2 px-5 rounded-xl transition
          ...
          <button
            ...
            className="mt-4 mx-10 w-45 bg-[#E5BC57] text-black flex items-center py-2 px-3 rounded-xl transition
          hover:brightness-110 hover:scale-105 active:scale-95"
          >
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6">
